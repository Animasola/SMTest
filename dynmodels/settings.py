...
STATICFILES_DIRS = (
    os.path.join(os.path.split(DEPLOY_DIR)[0], 'testapp', 'static'),
...
SECRET_KEY = '(79_+64g$853e-5*el)dmz40xnr27enw!ug@sh7!qm(=pm85l1'
...
TEMPLATE_DIRS = (
    os.path.join(DEPLOY_DIR, 'testapp', 'templates')
